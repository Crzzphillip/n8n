...
type FocusPanelStore = ReturnType<typeof createFocusPanelStore>;
let singleton: FocusPanelStore | undefined;

function createFocusPanelStore() {
...
export const useFocusPanelStore = () => {
	if (!singleton) singleton = createFocusPanelStore();
	return singleton;
};
