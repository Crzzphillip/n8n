...
type ExternalSecretsStore = ReturnType<typeof createExternalSecretsStore>;
let singleton: ExternalSecretsStore | undefined;

function createExternalSecretsStore() {
...
export const useExternalSecretsStore = () => {
	if (!singleton) singleton = createExternalSecretsStore();
	return singleton;
};
