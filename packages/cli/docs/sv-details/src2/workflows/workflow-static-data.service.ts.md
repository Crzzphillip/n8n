### src2/workflows/workflow-static-data.service.ts

Overview: src2/workflows/workflow-static-data.service.ts provides workflow orchestration support, from lookup and loading to execution services.
