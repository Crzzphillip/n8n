### src2/workflows/workflow-history.ee/__tests__/workflow-history.service.ee.test.ts

Overview: src2/workflows/workflow-history.ee/__tests__/workflow-history.service.ee.test.ts provides workflow orchestration support, from lookup and loading to execution services.
