### src2/workflows/workflow-history.ee/workflow-history.service.ee.ts

Overview: src2/workflows/workflow-history.ee/workflow-history.service.ee.ts provides workflow orchestration support, from lookup and loading to execution services.
