...
Overview: src2/task-runners/__tests__/task-runner-process-restart-loop-detector.test.ts belongs to the task runner subsystem for isolated background work.
