### src2/task-runners/__tests__/forward-to-logger.test.ts

Overview: src2/task-runners/__tests__/forward-to-logger.test.ts belongs to the task runner subsystem for isolated background work.
