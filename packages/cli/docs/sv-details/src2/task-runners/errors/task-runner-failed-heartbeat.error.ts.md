### src2/task-runners/errors/task-runner-failed-heartbeat.error.ts

Overview: src2/task-runners/errors/task-runner-failed-heartbeat.error.ts belongs to the task runner subsystem for isolated background work.
