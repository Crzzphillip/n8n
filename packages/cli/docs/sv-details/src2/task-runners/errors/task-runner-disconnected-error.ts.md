### src2/task-runners/errors/task-runner-disconnected-error.ts

Overview: src2/task-runners/errors/task-runner-disconnected-error.ts belongs to the task runner subsystem for isolated background work.
