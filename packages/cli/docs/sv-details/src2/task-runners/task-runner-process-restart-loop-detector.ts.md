### src2/task-runners/task-runner-process-restart-loop-detector.ts

Overview: src2/task-runners/task-runner-process-restart-loop-detector.ts belongs to the task runner subsystem for isolated background work.
