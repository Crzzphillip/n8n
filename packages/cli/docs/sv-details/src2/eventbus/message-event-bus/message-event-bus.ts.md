### src2/eventbus/message-event-bus/message-event-bus.ts

Overview: src2/eventbus/message-event-bus/message-event-bus.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
