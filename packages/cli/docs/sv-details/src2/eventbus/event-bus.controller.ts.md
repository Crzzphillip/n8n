### src2/eventbus/event-bus.controller.ts

Overview: src2/eventbus/event-bus.controller.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
