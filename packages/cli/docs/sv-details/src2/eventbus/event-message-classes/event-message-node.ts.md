### src2/eventbus/event-message-classes/event-message-node.ts

Overview: src2/eventbus/event-message-classes/event-message-node.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
