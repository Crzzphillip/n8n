...
Overview: src2/eventbus/event-message-classes/abstract-event-message-options.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
