...
Overview: src2/eventbus/event-message-classes/event-message-workflow.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
