### src2/services/ownership.service.ts

Overview: src2/services/ownership.service.ts provides a service (OwnershipService) encapsulating domain/business logic and integrations.
