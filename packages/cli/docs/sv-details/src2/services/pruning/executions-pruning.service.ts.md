### src2/services/pruning/executions-pruning.service.ts

Overview: src2/services/pruning/executions-pruning.service.ts provides a service (ExecutionsPruningService) encapsulating domain/business logic and integrations.
