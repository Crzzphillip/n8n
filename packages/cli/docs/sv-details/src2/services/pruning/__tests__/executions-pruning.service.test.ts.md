### src2/services/pruning/__tests__/executions-pruning.service.test.ts

Overview: src2/services/pruning/__tests__/executions-pruning.service.test.ts provides a service encapsulating domain/business logic and integrations.
