...
Overview: src2/events/__tests__/log-streaming-event-relay.test.ts is part of sv’s eventing layer, emitting and relaying internal events (e.g., logs, job signals).
