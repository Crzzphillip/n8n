...
Overview: src2/commands/import/credentials.ts declares a CLI command (ImportCredentialsCommand) named `import:credentials`, integrating into sv’s command runner.
