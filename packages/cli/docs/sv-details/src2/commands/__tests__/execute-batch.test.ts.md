### src2/commands/__tests__/execute-batch.test.ts

Overview: src2/commands/__tests__/execute-batch.test.ts declares a CLI command, integrating into sv’s command runner.
