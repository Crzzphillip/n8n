### src2/commands/list/workflow.ts

Overview: src2/commands/list/workflow.ts declares a CLI command (ListWorkflowCommand) named `list:workflow`, integrating into sv’s command runner.
