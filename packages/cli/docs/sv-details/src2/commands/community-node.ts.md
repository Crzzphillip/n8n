### src2/commands/community-node.ts

Overview: src2/commands/community-node.ts declares a CLI command (CommunityNode) named `community-node`, integrating into sv’s command runner.
