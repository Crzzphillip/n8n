### src2/controllers/oauth/oauth1-credential.controller.ts

Overview: src2/controllers/oauth/oauth1-credential.controller.ts defines an HTTP controller (OAuth1CredentialController) that exposes Express routes for a focused domain. Its base route is `/oauth1-credential`.
