### src2/controllers/owner.controller.ts

Overview: src2/controllers/owner.controller.ts defines an HTTP controller (OwnerController) that exposes Express routes for a focused domain. Its base route is `/owner`.
