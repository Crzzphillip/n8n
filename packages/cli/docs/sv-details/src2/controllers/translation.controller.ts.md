...
Overview: src2/controllers/translation.controller.ts defines an HTTP controller (TranslationController) that exposes Express routes for a focused domain. Its base route is `/`.
