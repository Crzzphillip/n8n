...
Overview: src2/controllers/user-settings.controller.ts defines an HTTP controller (UserSettingsController) that exposes Express routes for a focused domain. Its base route is `/user-settings`.
