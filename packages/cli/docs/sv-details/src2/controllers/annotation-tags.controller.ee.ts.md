...
Overview: src2/controllers/annotation-tags.controller.ee.ts defines an HTTP controller (AnnotationTagsController) that exposes Express routes for a focused domain. Its base route is `/annotation-tags`.
