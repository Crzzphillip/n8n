...
Overview: src2/controllers/cta.controller.ts defines an HTTP controller (CtaController) that exposes Express routes for a focused domain. Its base route is `/cta`.
