...
Overview: src2/controllers/orchestration.controller.ts defines an HTTP controller (OrchestrationController) that exposes Express routes for a focused domain. Its base route is `/orchestration`.
