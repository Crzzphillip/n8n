...
Overview: src2/controllers/debug.controller.ts defines an HTTP controller (DebugController) that exposes Express routes for a focused domain. Its base route is `/debug`.
