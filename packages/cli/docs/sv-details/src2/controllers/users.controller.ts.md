...
Overview: src2/controllers/users.controller.ts defines an HTTP controller (UsersController) that exposes Express routes for a focused domain. Its base route is `/users`.
