...
Overview: src2/controllers/dynamic-node-parameters.controller.ts defines an HTTP controller (DynamicNodeParametersController) that exposes Express routes for a focused domain. Its base route is `/dynamic-node-parameters`.
