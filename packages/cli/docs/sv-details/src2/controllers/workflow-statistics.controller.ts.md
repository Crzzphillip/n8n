### src2/controllers/workflow-statistics.controller.ts

Overview: src2/controllers/workflow-statistics.controller.ts defines an HTTP controller (WorkflowStatisticsController) that exposes Express routes for a focused domain. Its base route is `/workflow-stats`.
