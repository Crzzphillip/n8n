...
Overview: src2/controllers/active-workflows.controller.ts defines an HTTP controller (ActiveWorkflowsController) that exposes Express routes for a focused domain. Its base route is `/active-workflows`.
