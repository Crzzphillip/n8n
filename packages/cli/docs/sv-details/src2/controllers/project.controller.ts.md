### src2/controllers/project.controller.ts

Overview: src2/controllers/project.controller.ts defines an HTTP controller (ProjectController) that exposes Express routes for a focused domain. Its base route is `/projects`.
