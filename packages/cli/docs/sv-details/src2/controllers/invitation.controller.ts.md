### src2/controllers/invitation.controller.ts

Overview: src2/controllers/invitation.controller.ts defines an HTTP controller (InvitationController) that exposes Express routes for a focused domain. Its base route is `/invitations`.
