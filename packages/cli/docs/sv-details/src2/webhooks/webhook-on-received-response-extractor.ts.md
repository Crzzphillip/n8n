...
Overview: src2/webhooks/webhook-on-received-response-extractor.ts implements webhook registration, lookup, and request handling for workflow-triggered HTTP endpoints.
