...
Overview: src2/webhooks/__tests__/webhook-on-received-response-extractor.test.ts implements webhook registration, lookup, and request handling for workflow-triggered HTTP endpoints.
