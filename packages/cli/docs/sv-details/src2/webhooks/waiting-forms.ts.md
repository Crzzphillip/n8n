### src2/webhooks/waiting-forms.ts

Overview: src2/webhooks/waiting-forms.ts implements webhook registration, lookup, and request handling for workflow-triggered HTTP endpoints.
