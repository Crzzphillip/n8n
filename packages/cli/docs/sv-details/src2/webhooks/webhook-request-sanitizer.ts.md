### src2/webhooks/webhook-request-sanitizer.ts

Overview: src2/webhooks/webhook-request-sanitizer.ts implements webhook registration, lookup, and request handling for workflow-triggered HTTP endpoints.
