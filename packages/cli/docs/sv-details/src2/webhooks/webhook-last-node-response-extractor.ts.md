### src2/webhooks/webhook-last-node-response-extractor.ts

Overview: src2/webhooks/webhook-last-node-response-extractor.ts implements webhook registration, lookup, and request handling for workflow-triggered HTTP endpoints.
