...
Overview: src2/middlewares/list-query/dtos/credentials.select.dto.ts defines an Express middleware for request parsing, security headers, or query helpers.
