## src2/__tests__/credentials-helper.test.ts

Overview: src2/__tests__/credentials-helper.test.ts is a core component (TestApi) within the sv CLI runtime.
...
- Classes: TestApi, TestApi, TestApi, TestApi, TestApi

### Recreate

Place this file at `src2/__tests__/credentials-helper.test.ts` and use the following source:
