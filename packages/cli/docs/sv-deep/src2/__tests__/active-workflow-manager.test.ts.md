## src2/__tests__/active-workflow-manager.test.ts

Overview: src2/__tests__/active-workflow-manager.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/__tests__/active-workflow-manager.test.ts` and use the following source:
