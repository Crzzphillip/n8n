## src2/__tests__/wait-tracker.test.ts

Overview: src2/__tests__/wait-tracker.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/__tests__/wait-tracker.test.ts` and use the following source:
