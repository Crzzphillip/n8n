## src2/__tests__/load-nodes-and-credentials.test.ts

Overview: src2/__tests__/load-nodes-and-credentials.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/__tests__/load-nodes-and-credentials.test.ts` and use the following source:
