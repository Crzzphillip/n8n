## src2/__tests__/license.test.ts

Overview: src2/__tests__/license.test.ts is a core component within the sv CLI runtime.
...
- Functions: makeDateWithHourOffset

### Recreate

Place this file at `src2/__tests__/license.test.ts` and use the following source:
