## src2/services/credentials-tester.service.ts

Overview: src2/services/credentials-tester.service.ts provides a service (CredentialsTester) encapsulating domain logic and integrations.
...
- Classes: CredentialsTester
- Functions: oauth2CredTest, return, found, that
- Exports: CredentialsTester

### Recreate

Place this file at `src2/services/credentials-tester.service.ts` and use the following source:
