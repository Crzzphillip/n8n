## src2/services/cache/redis.cache-manager.ts

Overview: src2/services/cache/redis.cache-manager.ts provides a service (NoCacheableError) encapsulating domain logic and integrations.
...
- Classes: NoCacheableError
- Functions: builder, redisStoreUsingClient, redisStore
- Exports: NoCacheableError, avoidNoCacheable, RedisClusterConfig, RedisCache, RedisStore, redisStoreUsingClient

### Recreate

Place this file at `src2/services/cache/redis.cache-manager.ts` and use the following source:
