## src2/services/project.service.ee.ts

Overview: src2/services/project.service.ee.ts provides a service (TeamProjectOverQuotaError) encapsulating domain logic and integrations.
...
- Classes: TeamProjectOverQuotaError, UnlicensedProjectRoleError, ProjectNotFoundError, ProjectService
- Exports: TeamProjectOverQuotaError, UnlicensedProjectRoleError, ProjectService

### Recreate

Place this file at `src2/services/project.service.ee.ts` and use the following source:
