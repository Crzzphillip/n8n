## src2/environments.ee/source-control/__tests__/source-control-helper.ee.test.ts

Overview: src2/environments.ee/source-control/__tests__/source-control-helper.ee.test.ts is a core component within the sv CLI runtime.
...
- Functions: createWorkflowVersion, after, after

### Recreate

Place this file at `src2/environments.ee/source-control/__tests__/source-control-helper.ee.test.ts` and use the following source:
...
beforeAll(async () => {
	...
	sourceControlPreferencesService.getPreferences.mockReturnValue({
		...
		branchColor: '#5296D6',
		publicKey:
			'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDBSz2nMZAiUBWe6n89aWd5x9QMcIOaznVW3fpuCYC4L sv deploy key',
	});
});
