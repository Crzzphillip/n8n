## src2/environments.ee/source-control/source-control.service.ee.ts

Overview: src2/environments.ee/source-control/source-control.service.ee.ts is a core component (SourceControlService) within the sv CLI runtime.
...
- Classes: SourceControlService
- Exports: SourceControlService

### Recreate

Place this file at `src2/environments.ee/source-control/source-control.service.ee.ts` and use the following source:
