## src2/manual-execution.service.ts

Overview: src2/manual-execution.service.ts is a core component (ManualExecutionService) within the sv CLI runtime.
...
- Classes: ManualExecutionService
- Exports: ManualExecutionService

### Recreate

Place this file at `src2/manual-execution.service.ts` and use the following source:
