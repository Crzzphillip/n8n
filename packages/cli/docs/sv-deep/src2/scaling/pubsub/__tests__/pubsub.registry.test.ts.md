## src2/scaling/pubsub/__tests__/pubsub.registry.test.ts

Overview: src2/scaling/pubsub/__tests__/pubsub.registry.test.ts is a core component (TestService) within the sv CLI runtime.
...
Place this file at `src2/scaling/pubsub/__tests__/pubsub.registry.test.ts` and use the following source:
