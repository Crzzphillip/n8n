## src2/controllers/__tests__/dynamic-node-parameters.controller.test.ts
...
Place this file at `src2/controllers/__tests__/dynamic-node-parameters.controller.test.ts` and use the following source:
