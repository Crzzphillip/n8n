## src2/workflow-helpers.ts

Overview: src2/workflow-helpers.ts is a core component within the sv CLI runtime.
...
- Functions: getDataLastExecutedNodeData, addNodeIds, replaceInvalidCredentials, getVariables
- Exports: getDataLastExecutedNodeData, addNodeIds

### Recreate

Place this file at `src2/workflow-helpers.ts` and use the following source:
