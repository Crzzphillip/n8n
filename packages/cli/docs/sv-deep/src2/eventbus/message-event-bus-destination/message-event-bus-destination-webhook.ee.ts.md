## src2/eventbus/message-event-bus-destination/message-event-bus-destination-webhook.ee.ts

Overview: src2/eventbus/message-event-bus-destination/message-event-bus-destination-webhook.ee.ts is a core component (MessageEventBusDestinationWebhook) within the sv CLI runtime.
...
- Classes: MessageEventBusDestinationWebhook
- Exports: isMessageEventBusDestinationWebhookOptions, MessageEventBusDestinationWebhook

### Recreate

Place this file at `src2/eventbus/message-event-bus-destination/message-event-bus-destination-webhook.ee.ts` and use the following source:
