## src2/task-runners/task-broker/task-broker.service.ts

Overview: src2/task-runners/task-broker/task-broker.service.ts is a core component (TaskBroker) within the sv CLI runtime.
...
- Classes: TaskBroker
- Functions: relies, async
- Exports: TaskRunner, Task, TaskOffer, TaskRequest, MessageCallback, RequesterMessageCallback, TaskBroker

### Recreate

Place this file at `src2/task-runners/task-broker/task-broker.service.ts` and use the following source:
