## src2/task-runners/task-managers/task-requester.ts

Overview: src2/task-runners/task-managers/task-requester.ts is a core component (TaskRequester) within the sv CLI runtime.
...
- Classes: TaskRequester
- Exports: RequestAccept, RequestReject, TaskAccept, TaskReject, TaskRequest, Task

### Recreate

Place this file at `src2/task-runners/task-managers/task-requester.ts` and use the following source:
