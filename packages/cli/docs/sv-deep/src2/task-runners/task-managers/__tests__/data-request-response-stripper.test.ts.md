## src2/task-runners/task-managers/__tests__/data-request-response-stripper.test.ts

Overview: src2/task-runners/task-managers/__tests__/data-request-response-stripper.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/task-runners/task-managers/__tests__/data-request-response-stripper.test.ts` and use the following source:
