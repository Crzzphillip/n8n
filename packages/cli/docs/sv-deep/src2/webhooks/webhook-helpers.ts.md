## src2/webhooks/webhook-helpers.ts

Overview: src2/webhooks/webhook-helpers.ts is a core component within the sv CLI runtime.
...
- Functions: getWorkflowWebhooks, autoDetectResponseMode, setupResponseNodePromise, prepareExecutionData, executeWebhook, to, evaluateResponseOptions, parseRequestBody, evaluateResponseHeaders
- Exports: getWorkflowWebhooks, autoDetectResponseMode, handleFormRedirectionCase, setupResponseNodePromise, prepareExecutionData

### Recreate

Place this file at `src2/webhooks/webhook-helpers.ts` and use the following source:
