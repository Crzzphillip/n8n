## src2/webhooks/__tests__/webhook-last-node-response-extractor.test.ts

Overview: src2/webhooks/__tests__/webhook-last-node-response-extractor.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/webhooks/__tests__/webhook-last-node-response-extractor.test.ts` and use the following source:
