...
Overview: src2/executions/pre-execution-checks/__tests__/subworkflow-policy-checker.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/executions/pre-execution-checks/__tests__/subworkflow-policy-checker.test.ts` and use the following source:
