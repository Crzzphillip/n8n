## src2/executions/execution.service.ts

Overview: src2/executions/execution.service.ts is a core component (ExecutionService) within the sv CLI runtime.
...
- Classes: ExecutionService
- Exports: schemaGetExecutionsQueryFilter, allowedExecutionsQueryFilterFields, ExecutionService

### Recreate

Place this file at `src2/executions/execution.service.ts` and use the following source:
