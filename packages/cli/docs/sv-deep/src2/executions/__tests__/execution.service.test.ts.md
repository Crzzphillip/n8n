## src2/executions/__tests__/execution.service.test.ts

Overview: src2/executions/__tests__/execution.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/executions/__tests__/execution.service.test.ts` and use the following source:
