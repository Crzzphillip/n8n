## src2/push/__tests__/index.test.ts

Overview: src2/push/__tests__/index.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/push/__tests__/index.test.ts` and use the following source:
