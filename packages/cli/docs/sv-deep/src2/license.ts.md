...
Overview: src2/license.ts is a core component (License) within the sv CLI runtime.
...
- Classes: License
- Functions: to
- Exports: FeatureReturnType, License

### Recreate

Place this file at `src2/license.ts` and use the following source:
