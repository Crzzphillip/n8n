## src2/public-api/v1/handlers/audit/spec/schemas/audit.yml

Overview: src2/public-api/v1/handlers/audit/spec/schemas/audit.yml is a core component within the sv CLI runtime.
...
Place this file at `src2/public-api/v1/handlers/audit/spec/schemas/audit.yml` and use the following source:
        ...
        [
          {
            ...
            description: This node is sourced from the community. Community nodes are not vetted by the sv team and have full access to the host system.,
            recommendation: Consider reviewing the source code in any community nodes installed in this sv instance,
