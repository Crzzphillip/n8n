## src2/public-api/v1/handlers/credentials/credentials.service.ts

Overview: src2/public-api/v1/handlers/credentials/credentials.service.ts is a core component within the sv CLI runtime.
...
- Functions: getCredentials, getSharedCredentials, createCredential, saveCredential, removeCredential, encryptCredential, sanitizeCredentials, sanitizeCredentials, sanitizeCredentials, toJsonSchema
- Exports: sanitizeCredentials, sanitizeCredentials, sanitizeCredentials, toJsonSchema

### Recreate

Place this file at `src2/public-api/v1/handlers/credentials/credentials.service.ts` and use the following source:
