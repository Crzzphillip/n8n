## src2/public-api/v1/openapi.yml

Overview: src2/public-api/v1/openapi.yml is a core component within the sv CLI runtime.
...
Place this file at `src2/public-api/v1/openapi.yml` and use the following source:
...
info:
  ...
  version: 1.1.1
externalDocs:
  description: sv API documentation
