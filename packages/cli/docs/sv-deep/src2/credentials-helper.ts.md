## src2/credentials-helper.ts

Overview: src2/credentials-helper.ts is a core component (CredentialsHelper) within the sv CLI runtime.
...
- Classes: CredentialsHelper
- Functions: is, createCredentialsFromCredentialsEntity
- Exports: CredentialsHelper, createCredentialsFromCredentialsEntity

### Recreate

Place this file at `src2/credentials-helper.ts` and use the following source:
