## src2/execution-lifecycle/execution-lifecycle-hooks.ts

Overview: src2/execution-lifecycle/execution-lifecycle-hooks.ts is a core component (ModulesHooksRegistry) within the sv CLI runtime.
...
- Classes: ModulesHooksRegistry
- Functions: hookFunctionsWorkflowEvents, hookFunctionsNodeEvents, hookFunctionsPush, hookFunctionsExternalHooks, hookFunctionsSaveProgress, hookFunctionsFinalizeExecutionStatus, hookFunctionsStatistics, hookFunctionsSave, hookFunctionsSaveWorker, getLifecycleHooksForSubExecutions, getLifecycleHooksForScalingWorker, getLifecycleHooksForScalingMain, getLifecycleHooksForRegularMain
- Exports: getLifecycleHooksForSubExecutions, getLifecycleHooksForScalingWorker, getLifecycleHooksForScalingMain, getLifecycleHooksForRegularMain

### Recreate

Place this file at `src2/execution-lifecycle/execution-lifecycle-hooks.ts` and use the following source:
