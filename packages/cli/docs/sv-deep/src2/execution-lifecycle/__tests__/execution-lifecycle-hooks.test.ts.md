## src2/execution-lifecycle/__tests__/execution-lifecycle-hooks.test.ts

Overview: src2/execution-lifecycle/__tests__/execution-lifecycle-hooks.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/execution-lifecycle/__tests__/execution-lifecycle-hooks.test.ts` and use the following source:
