## src2/ldap.ee/ldap.service.ee.ts

Overview: src2/ldap.ee/ldap.service.ee.ts is a core component (LdapService) within the sv CLI runtime.
...
Place this file at `src2/ldap.ee/ldap.service.ee.ts` and use the following source:
