## src2/ldap.ee/__tests__/ldap.service.test.ts

Overview: src2/ldap.ee/__tests__/ldap.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/ldap.ee/__tests__/ldap.service.test.ts` and use the following source:
