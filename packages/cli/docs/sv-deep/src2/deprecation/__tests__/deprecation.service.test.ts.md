## src2/deprecation/__tests__/deprecation.service.test.ts

Overview: src2/deprecation/__tests__/deprecation.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/deprecation/__tests__/deprecation.service.test.ts` and use the following source:
