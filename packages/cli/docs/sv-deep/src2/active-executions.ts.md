## src2/active-executions.ts

Overview: src2/active-executions.ts is a core component (ActiveExecutions) within the sv CLI runtime.
...
- Classes: ActiveExecutions
- Exports: ActiveExecutions

### Recreate

Place this file at `src2/active-executions.ts` and use the following source:
