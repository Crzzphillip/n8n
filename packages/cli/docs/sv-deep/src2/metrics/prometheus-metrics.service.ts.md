## src2/metrics/prometheus-metrics.service.ts

Overview: src2/metrics/prometheus-metrics.service.ts is a core component (PrometheusMetricsService) within the sv CLI runtime.
...
- Classes: PrometheusMetricsService
- Exports: PrometheusMetricsService

### Recreate

Place this file at `src2/metrics/prometheus-metrics.service.ts` and use the following source:
...
export class PrometheusMetricsService {
	...
	/**
	 * Set up metric for sv version: `n8n_version_info`
	 */
