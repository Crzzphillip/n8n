## src2/metrics/__tests__/prometheus-metrics.service.test.ts

Overview: src2/metrics/__tests__/prometheus-metrics.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/metrics/__tests__/prometheus-metrics.service.test.ts` and use the following source:
...
describe('PrometheusMetricsService', () => {
	...
	describe('init', () => {
		...
		it('should setup active workflow count metric', async () => {
			...
			// First call is sv version metric
