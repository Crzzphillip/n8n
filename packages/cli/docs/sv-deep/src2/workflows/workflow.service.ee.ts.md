## src2/workflows/workflow.service.ee.ts

Overview: src2/workflows/workflow.service.ee.ts is a core component (EnterpriseWorkflowService) within the sv CLI runtime.
...
- Classes: EnterpriseWorkflowService
- Exports: EnterpriseWorkflowService

### Recreate

Place this file at `src2/workflows/workflow.service.ee.ts` and use the following source:
