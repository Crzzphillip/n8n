## src2/workflows/workflow-execution.service.ts

Overview: src2/workflows/workflow-execution.service.ts is a core component (WorkflowExecutionService) within the sv CLI runtime.
...
- Classes: WorkflowExecutionService
- Exports: WorkflowExecutionService

### Recreate

Place this file at `src2/workflows/workflow-execution.service.ts` and use the following source:
