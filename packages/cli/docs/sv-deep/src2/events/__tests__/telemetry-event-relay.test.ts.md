...
Overview: src2/events/__tests__/telemetry-event-relay.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/events/__tests__/telemetry-event-relay.test.ts` and use the following source:
