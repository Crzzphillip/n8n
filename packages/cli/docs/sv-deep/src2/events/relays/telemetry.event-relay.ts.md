## src2/events/relays/telemetry.event-relay.ts

Overview: src2/events/relays/telemetry.event-relay.ts is a core component (TelemetryEventRelay) within the sv CLI runtime.
...
- Classes: TelemetryEventRelay
- Exports: TelemetryEventRelay

### Recreate

Place this file at `src2/events/relays/telemetry.event-relay.ts` and use the following source:
