## src2/events/maps/relay.event-map.ts

Overview: src2/events/maps/relay.event-map.ts is a core component within the sv CLI runtime.
...
- Exports: UserLike, RelayEventMap

### Recreate

Place this file at `src2/events/maps/relay.event-map.ts` and use the following source:
