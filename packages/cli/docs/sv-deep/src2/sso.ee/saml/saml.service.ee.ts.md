## src2/sso.ee/saml/saml.service.ee.ts

Overview: src2/sso.ee/saml/saml.service.ee.ts is a core component (SamlService) within the sv CLI runtime.
...
Place this file at `src2/sso.ee/saml/saml.service.ee.ts` and use the following source:
