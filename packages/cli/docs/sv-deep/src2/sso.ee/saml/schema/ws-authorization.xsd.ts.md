## src2/sso.ee/saml/schema/ws-authorization.xsd.ts

Overview: src2/sso.ee/saml/schema/ws-authorization.xsd.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/sso.ee/saml/schema/ws-authorization.xsd.ts` and use the following source:
