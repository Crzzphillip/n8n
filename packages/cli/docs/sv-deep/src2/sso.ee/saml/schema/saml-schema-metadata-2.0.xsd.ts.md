## src2/sso.ee/saml/schema/saml-schema-metadata-2.0.xsd.ts
...
Place this file at `src2/sso.ee/saml/schema/saml-schema-metadata-2.0.xsd.ts` and use the following source:
