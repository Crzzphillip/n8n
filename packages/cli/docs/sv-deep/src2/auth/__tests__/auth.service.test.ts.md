## src2/auth/__tests__/auth.service.test.ts

Overview: src2/auth/__tests__/auth.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/auth/__tests__/auth.service.test.ts` and use the following source:
