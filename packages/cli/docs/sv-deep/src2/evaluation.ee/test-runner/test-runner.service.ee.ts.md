## src2/evaluation.ee/test-runner/test-runner.service.ee.ts

Overview: src2/evaluation.ee/test-runner/test-runner.service.ee.ts is a core component (TestRunnerService) within the sv CLI runtime.
...
- Classes: TestRunnerService
- Exports: TestRunMetadata, TestCaseExecutionResult, TestRunnerService

### Recreate

Place this file at `src2/evaluation.ee/test-runner/test-runner.service.ee.ts` and use the following source:
