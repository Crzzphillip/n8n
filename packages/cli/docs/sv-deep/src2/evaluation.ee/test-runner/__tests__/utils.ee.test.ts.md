## src2/evaluation.ee/test-runner/__tests__/utils.ee.test.ts

Overview: src2/evaluation.ee/test-runner/__tests__/utils.ee.test.ts is a core component within the sv CLI runtime.
...
- Functions: createRunDataMock

### Recreate

Place this file at `src2/evaluation.ee/test-runner/__tests__/utils.ee.test.ts` and use the following source:
