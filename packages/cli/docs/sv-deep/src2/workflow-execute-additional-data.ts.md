## src2/workflow-execute-additional-data.ts

Overview: src2/workflow-execute-additional-data.ts is a core component within the sv CLI runtime.
...
- Functions: getRunData, getWorkflowData, executeWorkflow, startExecution, we, setExecutionStatus, sendDataToUI, getBase
- Exports: setExecutionStatus, sendDataToUI

### Recreate

Place this file at `src2/workflow-execute-additional-data.ts` and use the following source:
