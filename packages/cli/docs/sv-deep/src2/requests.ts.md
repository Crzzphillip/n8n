...
Overview: src2/requests.ts is a core component within the sv CLI runtime.
...
- Functions: hasSharing
- Exports: AuthlessRequest, Request, Params, Options, hasSharing, SurveyAnswers, InviteResponse, Delete, Get, PasswordResetLink

### Recreate

Place this file at `src2/requests.ts` and use the following source:
