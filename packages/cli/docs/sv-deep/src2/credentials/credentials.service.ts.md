## src2/credentials/credentials.service.ts

Overview: src2/credentials/credentials.service.ts is a core component (CredentialsService) within the sv CLI runtime.
...
- Classes: CredentialsService
- Exports: CredentialsGetSharedOptions, CredentialsService

### Recreate

Place this file at `src2/credentials/credentials.service.ts` and use the following source:
...
export class CredentialsService {
	 ...
	 * Managed credentials are managed by sv and cannot be edited by the user.
	 */
