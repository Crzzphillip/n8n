## src2/databases/repositories/__tests__/folder.repository.test.ts

Overview: src2/databases/repositories/__tests__/folder.repository.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/databases/repositories/__tests__/folder.repository.test.ts` and use the following source:
