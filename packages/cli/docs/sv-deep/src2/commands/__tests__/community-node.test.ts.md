## src2/commands/__tests__/community-node.test.ts

Overview: src2/commands/__tests__/community-node.test.ts declares a CLI command.
...
Place this file at `src2/commands/__tests__/community-node.test.ts` and use the following source:
