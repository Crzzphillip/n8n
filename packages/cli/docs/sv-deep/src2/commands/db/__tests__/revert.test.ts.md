...
Overview: src2/commands/db/__tests__/revert.test.ts declares a CLI command (TestMigration).
...
- Classes: TestMigration, name, TestMigration, TestMigration, TestMigration

### Recreate

Place this file at `src2/commands/db/__tests__/revert.test.ts` and use the following source:
