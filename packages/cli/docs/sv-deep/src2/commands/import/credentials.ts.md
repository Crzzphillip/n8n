## src2/commands/import/credentials.ts

Overview: src2/commands/import/credentials.ts declares a CLI command (ImportCredentialsCommand). Command: `import:credentials`.
...
- Classes: ImportCredentialsCommand
- Exports: ImportCredentialsCommand

### Recreate

Place this file at `src2/commands/import/credentials.ts` and use the following source:
