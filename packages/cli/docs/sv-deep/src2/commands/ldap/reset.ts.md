## src2/commands/ldap/reset.ts

Overview: src2/commands/ldap/reset.ts declares a CLI command (Reset). Command: `ldap:reset`.
...
Place this file at `src2/commands/ldap/reset.ts` and use the following source:
