## src2/config/types.ts

Overview: src2/config/types.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/config/types.ts` and use the following source:
