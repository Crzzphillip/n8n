## src2/modules/external-secrets.ee/providers/vault.ts

Overview: src2/modules/external-secrets.ee/providers/vault.ts is a core component (VaultProvider) within the sv CLI runtime.
...
- Classes: VaultProvider
- Exports: VaultProvider

### Recreate

Place this file at `src2/modules/external-secrets.ee/providers/vault.ts` and use the following source:
