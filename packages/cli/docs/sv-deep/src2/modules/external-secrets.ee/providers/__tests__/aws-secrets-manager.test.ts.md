## src2/modules/external-secrets.ee/providers/__tests__/aws-secrets-manager.test.ts

Overview: src2/modules/external-secrets.ee/providers/__tests__/aws-secrets-manager.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/modules/external-secrets.ee/providers/__tests__/aws-secrets-manager.test.ts` and use the following source:
