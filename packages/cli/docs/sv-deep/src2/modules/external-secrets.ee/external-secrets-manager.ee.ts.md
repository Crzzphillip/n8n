...
Overview: src2/modules/external-secrets.ee/external-secrets-manager.ee.ts is a core component (ExternalSecretsManager) within the sv CLI runtime.
...
- Classes: ExternalSecretsManager
- Exports: ExternalSecretsManager

### Recreate

Place this file at `src2/modules/external-secrets.ee/external-secrets-manager.ee.ts` and use the following source:
