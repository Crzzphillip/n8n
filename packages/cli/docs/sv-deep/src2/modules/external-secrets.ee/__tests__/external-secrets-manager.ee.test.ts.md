## src2/modules/external-secrets.ee/__tests__/external-secrets-manager.ee.test.ts

Overview: src2/modules/external-secrets.ee/__tests__/external-secrets-manager.ee.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/modules/external-secrets.ee/__tests__/external-secrets-manager.ee.test.ts` and use the following source:
