## src2/modules/insights/__tests__/insights-collection.service.test.ts

Overview: src2/modules/insights/__tests__/insights-collection.service.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/modules/insights/__tests__/insights-collection.service.test.ts` and use the following source:
