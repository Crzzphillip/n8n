## src2/modules/insights/__tests__/insights.controller.test.ts

Overview: src2/modules/insights/__tests__/insights.controller.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/modules/insights/__tests__/insights.controller.test.ts` and use the following source:
