## src2/telemetry/__tests__/telemetry.test.ts

Overview: src2/telemetry/__tests__/telemetry.test.ts is a core component within the sv CLI runtime.
...
Place this file at `src2/telemetry/__tests__/telemetry.test.ts` and use the following source:
